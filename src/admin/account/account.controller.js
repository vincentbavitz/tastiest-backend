...
var AccountController = /** @class */ (function () {
     ...
     * @link AdminService
     */
    AccountController.prototype.getAccounts = function (getAccountsDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.accountService.getAccounts(getAccountsDto.role, getAccountsDto.limit, getAccountsDto.pageToken)];
            });
        });
    };
    /** Get a particular user in Firebase. */
    AccountController.prototype.getAccount = function (req, getAccountDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.accountService.getAccount(getAccountDto.uid)];
            });
        });
    };
    /**f
     ...
     */
    AccountController.prototype.setUserRole = function (setAccountRoleDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.accountService.setAccountRole(setAccountRoleDto.uid, setAccountRoleDto.role)];
            });
        });
    };
    __decorate([
    ...
    ], AccountController.prototype, "setUserRole");
