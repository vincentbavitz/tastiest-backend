...
var validation_exception_1 = require("./filters/validation.exception");
var validation_filter_1 = require("./filters/validation.filter");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.useGlobalPipes(new common_1.ValidationPipe({
                        ...
                        exceptionFactory: function (errors) {
                            var messages = errors.map(function (error) {
                                return {
                                    error: "".concat(error.property, " has wrong value ").concat(error.value, "."),
                    ...
                    return [4 /*yield*/, app.listen(4444)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
